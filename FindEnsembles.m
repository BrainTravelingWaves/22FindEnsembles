...
%% Load parametrs
ShowSig=1; % Save signal for show ShowSig=1, no save ShowSig=0 
                 ...
                 for i=2:N                  
                     ...
                     if cri>trhR
                        if cpi<trhP 
                           % SaveShowSig
                           if ShowSig==1
                               nameShow=strcat(name_word,num2str(irpd),'Ch',num2str(StdSgn(i)),'.mat');
                               SigShow(1,:)=SigG(ChnS1,:);
                               SigShow(2,:)=SigG(StdSgn(i),:);
                               save(nameShow,'SigShow')
                           end
                           % 
...
% To view zavitoy1Ch156.mat, load it to workspace and execute the plot(SigShow') command